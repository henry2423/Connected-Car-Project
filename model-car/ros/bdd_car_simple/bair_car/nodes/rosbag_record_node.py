...
if __name__ == '__main__':
    ...
    unix('scp -r /home/nvidia/catkin_ws/src/bdd_car_simple/bair_car ' + opj(bag_rec_folder,'.bair_car'))
    #unix('scp /home/ubuntu/model_car/model_car/model/z2_color_tf.npy ' + opj(bag_rec_folder,'.AI'))
    unix('scp /home/nvidia/Desktop/model_car/model_car/model/z2_color_version_1b_final.hdf5 ' + opj(bag_rec_folder,'.AI'))
